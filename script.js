...
let gattahuCurrentLevel = 75; // 초기 레벨 2배 -> 15 * 5 = 75
let gattahuCurrentStage = 1;
let gattahuCurrentBetUnit = 0;
let gattahuTotalUnits = 75; // 시작 유닛 2배 -> 15 * 5 = 75
...
const gattahuLevelMap = {
    ...
    25: { // 5 * 5 = 25
        1: { bet1: 10, bet2: 20, win: { type: 'calcLevelSumCurrentLevel', units: [10, 20] }, lose: { type: 'goto', stage: 2 } }, // bet1: 2*5=10, bet2: 4*5=20, units: [2*5, 4*5]
        2: { bet: 15, win: { type: 'goto', level: 30 }, lose: { type: 'gameOver' } }
    },
    30: { // 6 * 5 = 30
        1: { bet1: 10, bet2: 20, win: { type: 'calcLevelSumCurrentLevel', units: [10, 20] }, lose: { type: 'goto', stage: 2 } }, // bet1: 2*5=10, bet2: 4*5=20, units: [2*5, 4*5]
        2: { bet: 20, win: { type: 'goto', level: 40 }, lose: { type: 'gameOver' } }
    },
    35: { // 7 * 5 = 35
        1: { bet1: 10, bet2: 20, win: { type: 'calcLevelSumCurrentLevel', units: [10, 20] }, lose: { type: 'goto', stage: 2 } }, // bet1: 2*5=10, bet2: 4*5=20, units: [2*5, 4*5]
        2: { bet: 25, win: { type: 'goto', level: 50 }, lose: { type: 'gameOver' } }
    },
    40: { // 8 * 5 = 40
        1: { bet1: 10, bet2: 20, win: { type: 'calcLevelSumCurrentLevel', units: [10, 20] }, lose: { type: 'goto', stage: 2 } }, // bet1: 2*5=10, bet2: 4*5=20, units: [2*5, 4*5]
        2: { bet: 30, win: { type: 'goto', level: 60 }, lose: { type: 'gameOver' } }
    },
    45: { // 9 * 5 = 45
        1: { bet1: 10, bet2: 20, win: { type: 'calcLevelSumCurrentLevel', units: [10, 20] }, lose: { type: 'goto', stage: 2 } }, // bet1: 2*5=10, bet2: 4*5=20, units: [2*5, 4*5]
        2: { bet: 35, win: { type: 'goto', level: 70 }, lose: { type: 'gameOver' } }
    },
    50: { // 10 * 5 = 50
        1: { bet1: 5, bet2: 10, win: { type: 'calcLevelSumCurrentLevel', units: [5, 10] }, lose: { type: 'goto', stage: 2 } }, // bet1: 1*5=5, bet2: 2*5=10, units: [1*5, 2*5]
        2: { bet1: 10, bet2: 20, win: { type: 'calcLevelSumCurrentLevelSubtract', units: [10, 20], subtract: 5 }, lose: { type: 'goto', stage: 3 } }, // bet1: 2*5=10, bet2: 4*5=20, units: [2*5, 4*5], subtract: 1*5=5
        3: { bet: 35, win: { type: 'goto', level: 70 }, lose: { type: 'gameOver' } } // bet: 7*5=35, level: 14*5=70
    },
    55: { // 11 * 5 = 55
        1: { bet: 10, win: { type: 'calcLevelSumCurrentLevel', units: [10] }, lose: { type: 'goto', stage: 2 } }, // bet: 2*5=10, units: [2*5]
        2: { bet1: 10, bet2: 20, win: { type: 'calcLevelSumCurrentLevelSubtract', units: [10, 20], subtract: 5 }, lose: { type: 'goto', stage: 3 } }, // bet1: 2*5=10, bet2: 4*5=20, units: [2*5, 4*5], subtract: 1*5=5
        3: { bet: 35, win: { type: 'goto', level: 70 }, lose: { type: 'gameOver' } } // bet: 7*5=35, level: 14*5=70
    },
    60: { // 12 * 5 = 60
        1: { bet1: 5, bet2: 10, win: { type: 'calcLevelSumCurrentLevel', units: [5, 10] }, lose: { type: 'goto', stage: 2 } }, // bet1: 1*5=5, bet2: 2*5=10, units: [1*5, 2*5]
        2: { bet1: 10, bet2: 20, win: { type: 'calcLevelSumCurrentLevelSubtract', units: [10, 20], subtract: 5 }, lose: { type: 'goto', stage: 3 } }, // bet1: 2*5=10, bet2: 4*5=20, units: [2*5, 4*5], subtract: 1*5=5
        3: { bet1: 10, bet2: 20, win: { type: 'calcLevelSumCurrentLevelSubtract', units: [10, 20], subtract: 15 }, lose: { type: 'goto', stage: 4 } }, // bet1: 2*5=10, bet2: 4*5=20, units: [2*5, 4*5], subtract: 3*5=15
    ...
    70: { // 14 * 5 = 70
        ...
        3: { bet1: 15, bet2: 30, win: { type: 'calcLevelSumCurrentLevelSubtract', units: [15, 30], subtract: 25 }, lose: { type: 'gotoLevel', level: 30 } } // bet1: 3*5=15, bet2: 6*5=30, units: [3*5, 6*5], subtract: 5*5=25, level: 6*5=30
    },
    75: { // 15 * 5 = 75
        1: { bet1: 5, bet2: 10, win: { type: 'calcLevelSumCurrentLevel', units: [5, 10] }, lose: { type: 'goto', stage: 2 } }, // bet1: 1*5=5, bet2: 2*5=10, units: [1*5, 2*5]
        2: { bet1: 10, bet2: 20, win: { type: 'calcLevelSumCurrentLevelSubtract', units: [10, 20], subtract: 5 }, lose: { type: 'goto', stage: 3 } }, // bet1: 2*5=10, bet2: 4*5=20, units: [2*5, 4*5], subtract: 1*5=5
        3: { bet: 15, win: { type: 'calcLevelSumCurrentLevelSubtract', units: [15], subtract: 15 }, lose: { type: 'goto', stage: 4 } }, // bet: 3*5=15, units: [3*5], subtract: 3*5=15
        4: { bet1: 15, bet2: 30, win: { type: 'calcLevelSumCurrentLevelSubtract', units: [15, 30], subtract: 30 }, lose: { type: 'calcLevelSubCurrentLevel', subtract: 45 } } // bet1: 3*5=15, bet2: 6*5=30, units: [3*5, 6*5], subtract: 6*5=30, subtract: 9*5=45
    },
    80: { // 16 * 5 = 80
        1: { bet1: 5, bet2: 10, win: { type: 'calcLevelSumCurrentLevel', units: [5, 10] }, lose: { type: 'goto', stage: 2 } }, // bet1: 1*5=5, bet2: 2*5=10, units: [1*5, 2*5]
        2: { bet1: 10, bet2: 20, win: { type: 'calcLevelSumCurrentLevelSubtract', units: [10, 20], subtract: 5 }, lose: { type: 'goto', stage: 3 } }, // bet1: 2*5=10, bet2: 4*5=20, units: [2*5, 4*5], subtract: 1*5=5
    ...
    110: { // 22 * 5 = 110
        1: { bet1: 5, bet2: 10, win: { type: 'calcLevelSumCurrentLevel', units: [5, 10] }, lose: { type: 'goto', stage: 2 } }, // bet1: 1*5=5, bet2: 2*5=10, units: [1*5, 2*5]
        2: { bet1: 10, bet2: 20, win: { type: 'calcLevelSumCurrentLevelSubtract', units: [10, 20], subtract: 5 }, lose: { type: 'goto', stage: 3 } }, // bet1: 2*5=10, bet2: 4*5=20, units: [2*5, 4*5], subtract: 1*5=5
        3: { bet1: 15, bet2: 30, win: { type: 'calcLevelSumCurrentLevelSubtract', units: [15, 30], subtract: 15 }, lose: { type: 'goto', stage: 4 } }, // bet1: 3*5=15, bet2: 6*5=30, units: [3*5, 6*5], subtract: 3*5=15
        4: {
            bet1: 45, bet2: 15, // bet1: 9*5=45, bet2: 3*5=15
            win: { type: 'calcLevelSumCurrentLevelSubtract', units: [45, 15], subtract: 30 }, // units: [9*5, 3*5], subtract: 6*5=30
    ...
    125: { // 25 * 5 = 125
        1: { bet1: 5, bet2: 10, win: { type: 'calcLevelSumCurrentLevel', units: [5, 10] }, lose: { type: 'goto', stage: 2 } }, // bet1: 1*5=5, bet2: 2*5=10, units: [1*5, 2*5]
        2: { bet1: 10, bet2: 20, win: { type: 'calcLevelSumCurrentLevelSubtract', units: [10, 20], subtract: 5 }, lose: { type: 'goto', stage: 3 } }, // bet1: 2*5=10, bet2: 4*5=20, units: [2*5, 4*5], subtract: 1*5=5
        3: { bet1: 15, bet2: 25, win: { type: 'calcLevelSumCurrentLevelSubtract', units: [15, 25], subtract: 15 }, lose: { type: 'goto', stage: 4 } }, // bet1: 3*5=15, bet2: 5*5=25, units: [3*5, 5*5], subtract: 3*5=15
        4: {
            bet1: 45, bet2: 10, // bet1: 9*5=45, bet2: 2*5=10
            win: { type: 'calcLevelSumCurrentLevelSubtract', units: [45, 10], subtract: 30 }, // units: [9*5, 2*5], subtract: 6*5=30
            lose: { type: 'specialLoseLevel25_4' } // 1번째 패배, 2번째 패배 로직 분리
        }
    },
    130: { // 26 * 5 = 130
        1: { bet1: 5, bet2: 10, win: { type: 'calcLevelSumCurrentLevel', units: [5, 10] }, lose: { type: 'goto', stage: 2 } }, // bet1: 1*5=5, bet2: 2*5=10, units: [1*5, 2*5]
        2: { bet1: 10, bet2: 15, win: { type: 'calcLevelSumCurrentLevelSubtract', units: [10, 15], subtract: 5 }, lose: { type: 'goto', stage: 3 } }, // bet1: 2*5=10, bet2: 3*5=15, units: [2*5, 3*5], subtract: 1*5=5
        3: { bet1: 15, bet2: 20, win: { type: 'calcLevelSumCurrentLevelSubtract', units: [15, 20], subtract: 15 }, lose: { type: 'goto', stage: 4 } }, // bet1: 3*5=15, bet2: 4*5=20, units: [3*5, 4*5], subtract: 3*5=15
        4: {
            bet1: 45, bet2: 5, // bet1: 9*5=45, bet2: 1*5=5
            win: { type: 'calcLevelSumCurrentLevelSubtract', units: [45, 5], subtract: 30 }, // units: [9*5, 1*5], subtract: 6*5=30
            lose: { type: 'specialLoseLevel26_4' } // 1번째 패배, 2번째 패배 로직 분리
        }
    },
    135: { // 27 * 5 = 135
        1: { bet1: 5, bet2: 10, win: { type: 'calcLevelSumCurrentLevel', units: [5, 10] }, lose: { type: 'goto', stage: 2 } }, // bet1: 1*5=5, bet2: 2*5=10, units: [1*5, 2*5]
        2: { bet1: 10, bet2: 10, win: { type: 'calcLevelSumCurrentLevelSubtract', units: [10, 10], subtract: 5 }, lose: { type: 'goto', stage: 3 } }, // bet1: 2*5=10, bet2: 2*5=10, units: [2*5, 2*5], subtract: 1*5=5
        3: { bet1: 15, bet2: 15, win: { type: 'calcLevelSumCurrentLevelSubtract', units: [15, 15], subtract: 15 }, lose: { type: 'goto', stage: 4 } }, // bet1: 3*5=15, bet2: 3*5=15, units: [3*5, 3*5], subtract: 3*5=15
        4: { bet: 45, win: { type: 'goto', level: 150 }, lose: { type: 'gotoLevel', level: 60 } } // bet: 9*5=45, level: 30*5=150, level: 12*5=60
    },
    140: { // 28 * 5 = 140
        1: { bet1: 5, bet2: 5, win: { type: 'calcLevelSumCurrentLevel', units: [5, 5] }, lose: { type: 'goto', stage: 2 } }, // bet1: 1*5=5, bet2: 1*5=5, units: [1*5, 1*5]
        2: { bet1: 10, bet2: 5, win: { type: 'calcLevelSumCurrentLevelSubtract', units: [10, 5], subtract: 5 }, lose: { type: 'goto', stage: 3 } }, // bet1: 2*5=10, bet2: 1*5=5, units: [2*5, 1*5], subtract: 1*5=5
        3: { bet1: 15, bet2: 10, win: { type: 'calcLevelSumCurrentLevelSubtract', units: [15, 10], subtract: 15 }, lose: { type: 'goto', stage: 4 } }, // bet1: 3*5=15, bet2: 2*5=10, units: [3*5, 2*5], subtract: 3*5=15
    ...
    145: { // 29 * 5 = 145
        ...
        3: { bet1: 15, bet2: 5, win: { type: 'calcLevelSumCurrentLevelSubtract', units: [15, 5], subtract: 15 }, lose: { type: 'goto', stage: 4 } }, // bet1: 3*5=15, bet2: 1*5=5, units: [3*5, 1*5], subtract: 3*5=15
        4: { bet: 35, win: { type: 'goto', level: 150 }, lose: { type: 'gotoLevel', level: 80 } } // bet: 7*5=35, level: 30*5=150, level: 16*5=80
    },
    150: { // 30 * 5 = 150
        1: { bet: 50, win: { type: 'gameWin' }, lose: { type: 'gameOver' } } // 예시: 레벨 30의 최종 베팅, bet: 10*5=50
    }
};
...
function gattahuInitializeGame() {
    gattahuCurrentLevel = 75; // 시작 레벨 2배 -> 15 * 5 = 75
    gattahuCurrentStage = 1;
    gattahuTotalUnits = 75; // 시작 유닛 2배 -> 15 * 5 = 75
...
function gattahuUpdateDisplay() {
    ...
    // 게임 승리 조건 확인
    if (gattahuTotalUnits >= 150) { // 승리 유닛 2배 -> 30 * 5 = 150
    ...
    if (gattahuTotalUnits <= 0 && !(gattahuCurrentLevel === 150 && gattahuCurrentStage === 1 && gattahuTotalUnits === 150)) { // 초기 유닛도 2배로 고려 -> 원래 값으로 * 5
...
function gattahuHandleLose() {
    ...
    // 레벨 44-52 (기존 22-26)의 4단계 특수 패배 로직
        ...
        // 아니면 (대부분 2번째 베팅 유닛 bet2에서 패배한 경우) 2번째 패팅으로 간주
        if (unitsLost === (stageData.bet1)) { // bet1도 2배로 계산된 값과 비교 -> 원래 값으로 * 5
            nextLevel = gattahuCurrentLevel - 75; // 15 레벨 감소 * 5 = 75
            gattahuMessageEl.textContent = `패배! (1번째 베팅 실패) 레벨 ${nextLevel}로 이동합니다.`;
        } else if (unitsLost === (stageData.bet2)) { // bet2도 2배로 계산된 값과 비교 -> 원래 값으로 * 5
            if (stageData.lose.type === 'specialLoseLevel25_4') { // 기존 25레벨
                nextLevel = gattahuCurrentLevel + 5; // 1 레벨 증가 * 5 = 5
                gattahuMessageEl.textContent = `패배! (2번째 베팅 실패) 레벨 ${nextLevel}로 이동합니다.`;
            } else if (stageData.lose.type === 'specialLoseLevel26_4') { // 기존 26레벨
                nextLevel = gattahuCurrentLevel + 10; // 2 레벨 증가 * 5 = 10
                gattahuMessageEl.textContent = `패배! (2번째 베팅 실패) 레벨 ${nextLevel}로 이동합니다.`;
            } else { // 22, 23, 24의 4단계 2번째 베팅 패배 시 (2배된 레벨 기준 44, 46, 48) -> 원래 값으로 * 5
